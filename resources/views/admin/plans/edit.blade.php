    ...
    <div class="card-body">
        <form action="{{ route("admin.plans.update", [$plan->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                <label for="name">{{ trans('cruds.plan.fields.title') }}*</label>
                ...
                <p class="helper-block">
                    {{ trans('cruds.plan.fields.title_helper') }}
                </p>
            </div>
            <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                <label for="description">{{ trans('cruds.plan.fields.description') }}</label>
                <textarea id="description" name="description" class="form-control ">{{ old('description', isset($plan) ? $plan->description : '') }}</textarea>
